...
namespace ImageEffectGraph.Editor
{
    ...
    public class MotionVectorsTextureNode : AbstractMaterialNode, IGeneratesBodyCode, IMayRequireMeshUV
    {
        ...
        const string kTextureInputName = "_CameraMotionVectorsTexture";

        public override bool hasPreview => true;

        public MotionVectorsTextureNode()
        {
